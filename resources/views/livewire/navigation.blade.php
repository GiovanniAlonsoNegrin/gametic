                    ...
                    <div x-data="{ open:false }" class="relative ml-3">
                        <div>
                            <button x-on:click="open = true" type="button"
                                ...
                                id="user-menu-button" aria-expanded="false" aria-haspopup="true" x-click>
                                <span class="absolute -inset-1.5"></span>
            ...
            -->
                        <div x-show="open" x-on:click.away="open = false" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                            ...
                            <form method="POST" action="{{ route('logout') }}" x-data>
                                ...
                                <a @click.prevent="$root.submit();" href="{{ route('logout') }}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">
                                    Sign out
                                </a>
                            </form>
                        </div>
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            ...
            <div class="mt-3 space-y-1 px-2">
                ...
                <form method="POST" action="{{ route('logout') }}" x-data>
                    ...
                    <a @click.prevent="$root.submit();" href="{{ route('logout') }}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">
                        Sign out
                    </a>
                </form>
                @else
